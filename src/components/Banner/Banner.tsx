            ...
            <div className="d-flex justify-content-between">
                <div className="header-left ">
                    ...
                    <a href="#search-sections" className="header-m-5 align-items-center button-header d-flex  justify-content-center">
                        <img alt="pokeball button" loading="eager" src="/assets/pokemonButton.svg" />
                        See pokemons
                    </a>
                    <div className="pokeball header-m-5  float-area">
                        <img alt="pokeball" loading="eager" className="m-auto floating-img" src="/assets/pokeball.svg" />
                    </div>
                </div>
